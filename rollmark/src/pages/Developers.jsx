...
const Developers = () => {
  return (
      ...
      <section className="py-6 dark:bg-gray-100 dark:text-grey-600">
	<div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
		<p className="p-2 text-3xl font-bold tracking-wider text-center uppercase">Development team</p> <br />
		<h1 className="text-4xl font-bold leading-none text-center sm:text-3xl">The talented people behind the scenes</h1>
		<div className="flex flex-row flex-wrap-reverse justify-center mt-8">
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-indigo-600 dark:text-gray-100">
				...
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-50 ">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
							<path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
							<path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
						</svg>
					</a>
					<a rel="noopener noreferrer" href="#" title="Twitter" className="dark:text-gray-50 ">
					...
					<a rel="noopener noreferrer" href="#" title="LinkedIn" className="dark:text-gray-50 ">
					...
					<a rel="noopener noreferrer" href="#" title="GitHub" className="dark:text-gray-50 ">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
