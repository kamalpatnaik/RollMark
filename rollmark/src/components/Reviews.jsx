...
const Reviews = () => {
  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-6">
      ...
      <div className="flex flex-col gap-3 rounded-lg border p-4 md:p-6 hover:scale-105 hover:border-amber-500 shadow-2xl transition delay-100">
        <div>
          <span className="block text-sm font-bold md:text-base">John McCulling</span>
       ...
       <div className="flex flex-col gap-3 rounded-lg border p-4 md:p-6 hover:scale-105 hover:border-amber-600 shadow-2xl transition delay-100">
        <div>
          <span className="block text-sm font-bold md:text-base">Kate Berg</span>
       ...
       <div className="flex flex-col gap-3 rounded-lg border p-4 md:p-6 hover:scale-105 hover:border-amber-600 shadow-2xl transition delay-100">
        <div>
          <span className="block text-sm font-bold md:text-base">Greg Jackson</span>
