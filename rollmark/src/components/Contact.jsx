...
const Contact = () => {
  const handleSend = () => {
    ...
    const contact = document.querySelector('input[placeholder="CONTACT NO"]').value;
    const message = document.querySelector('input[placeholder="MESSAGE"]').value;

    const mailtoLink = `mailto:contact@incosstech.com?subject=Contact from ${name}&body=Name: ${name}%0AEmail: ${email}%0AContact: ${contact}%0AMessage: ${message}`;
